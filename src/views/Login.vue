            ...
            <div class="content-wrap">
                <form>
                    <ul>
                        ...
                        <li class="psd"><input type="text" v-model="code" placeholder="请输入验证码">
                            <button type="button" @click="getCode()" class="code">{{text}}</button>
                        </li>
                        <div class="checkbox">
...
<script>
    ...
    export default {
        ...
        methods: {
            wechatLogin() {
                window.location.href = "http://www.hui5288.com/hui/hui.html";
            },
            loadUserProtalInfo() {
                var page = this;
