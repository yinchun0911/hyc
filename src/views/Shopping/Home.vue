            ...
            <div class="list-box">
                ...
                <ul>
                    <li v-for="item  in productList">
                        <div class="check fl">
                            <el-checkbox :data-id="item.goodsid" v-model="checkIds[item.goodsid]"
                                         @change="countCheckTotal()"></el-checkbox>
                        </div>
                        <div class="img fl"
                             @click="goByPathTo('detail',{productID:item.productID ,goodsid:item.goodsid})">
                        ...
                        <div class="msg">
                            ...
                            <div class="prices">
                                ...
                                <van-stepper v-model="productNum[item.goodsid]" integer min="1" max="10"
                                             @change="countCheckTotal(item.goodsid)"/>
                            </div>
                        </div>
                    </li>
                </ul>
