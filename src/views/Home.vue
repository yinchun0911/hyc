<template>
    <div class="home">
        <SearchHeader @sweepCodeClick="sweepCodeClick" @msgEventClick="msgEventClick" :badgeNum="msgNum"
                      @searchClick="searchClick"></SearchHeader>
        <div class="banner">
        ...
        <div class="content">
            ...
            <div class="nav">
                <ul>
                    <li v-for="item in navList" :data-link="item.menuLink" @click="goByPathTo(item.menuLink)"><img
                            :src="item.menuIcon" alt="">{{item.menuName}}
                    </li>
                </ul>
            </div>
            <div class="main">
                <img @click="goByPathTo('list',{areaID:special1.activityAreaID,fromHome:true})"
                     :src="special1.activityAreaPic" alt="">
                <img @click="goByPathTo('list',{areaID:special2.activityAreaID,fromHome:true})"
                     :src="special2.activityAreaPic" alt="">
            </div>
            <div class="more-box">
                <img @click="goByPathTo('list',{areaID:special3.activityAreaID,fromHome:true})"
                     :src="special3.activityAreaPic" alt="">
            </div>


            <template v-for="(special,index) in specialArea">
                <div class="specialArea" :id="special.activityAreaID">
                    <h3>{{ special.activityAreaName }}<span
                            @click="goByPathTo('list',{areaID:special.activityAreaID})">更多&gt;</span></h3>
                    <div class="areaBanner">
                        <img @click="goByPathTo('list',{areaID:special.activityAreaID,fromHome:true})"
                             :src="special.activityAreaPic" alt="">
                    </div>
                    <ul>
