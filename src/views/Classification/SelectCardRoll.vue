        ...
        <div class="content">
            ...
            <div class="orderMsg">
                <ul>
                    ...
                    <li><label>合计：</label><span>{{order.totleProduct}}</span>（含运费：<span>{{order.totleFreight}}</span>）
                    </li>
                </ul>
                <div class="checkbox">
                    <el-checkbox v-model="checked"></el-checkbox>
                    <span @click="dialogVisible = true">阅读并同意<i>服务协议</i></span>
                </div>
            </div>
            ...
            <div class="btns">
                ...
                <button class="weixinBtn" @click="wxpay">微信支付<span>{{order.totleProduct}}</span></button>
            </div>
            <!--添加卡片-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeSelect(item) {
                if (this.selectCard != item.cardID) {
                    this.selectCard = item.cardID
                    this.selectCardBalance = item.cardBalance;
                } else {
                    this.selectCard = -1
                    this.selectCardBalance = 0;
                }
            },
            ...
            pay() {
                ...
                if (page.order.totleMoney > page.selectCardBalance) {
                }
