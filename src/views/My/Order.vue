            ...
            <template v-for="order in orderList">
                <div class="listWarp">
                    <h2 @click="goDetail(order)">
                        ...
                        <div v-if="order.leftTime!=0 && order.orderStatus==1" :data-leftTime="order.leftTime"
                             class="time">
                            请在
                    ...
                    <div class="listMsg">
                        ...
                        <div class="btnBox" v-if="order.orderStatus ==2 "
                             @click="causeShow=true;actionType='cancel';opOrder=order">
                            <button>取消订单</button>
                        </div>
                        <div class="btnBox" v-if="order.orderStatus ==4 && order.isBack==1"
                             @click="causeShow=true;actionType='refund';opOrder=order">
                            <button>申请退货</button>
                        </div>
